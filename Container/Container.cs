...
namespace DeveloperSample.Container
{
    public class Container
    {
        ...
        {
            bool isValidParams = (interfaceType != null) && (implementationType != null) &&
                                interfaceType.IsInterface && implementationType.IsClass;
            if (!isValidParams)
        ...
        public T Get<T>()
        {
            ...
            if (bindingList.ContainsKey(t))
                ...
                throw new Exception("Interface can't be initialized without binding to class first!");
            else
                throw new Exception("Type T should be a class or interface!");
        }
    }
}
